...
const bindClassNames = (schema, element, initialClassNames) => {
  Reflect.defineProperty(schema, 'classNames', {
    get() {
  ...
  schema.classNames = initialClassNames;
};
...
const compile = (schema, container) => {
  ...
  bindClassNames(schema, element, classNames);
